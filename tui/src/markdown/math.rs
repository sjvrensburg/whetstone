...
//!
//! Vendored from `leboiko/markdown-reader` (`src/markdown/math.rs`) under
//! the MIT License (rustfmt-formatted, otherwise unchanged) — see
//! `tui/THIRD_PARTY_NOTICES.md` for the full notice. Best-effort,
//! zero-dependency: converts common LaTeX math commands to their Unicode
//! equivalents so display and inline math render readably in a terminal
//! without a full typesetting engine. The output is plain text — no
//! rasterisation, no external dependencies.
//!
