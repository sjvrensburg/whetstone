...
complete -c whetstone-tui -n "__fish_whetstone_tui_using_subcommand help; and not __fish_seen_subcommand_from open lint coach guard ownership disclosure export words help" -f -a "words" -d 'Word/character/line counts for a document (JSON)'
